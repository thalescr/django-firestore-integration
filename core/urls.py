...
urlpatterns = [
    # Certificates
    path('', views.CertList.as_view(), name='cert_list'),
    path('cert/create', views.CertCreate.as_view(), name='cert_create'),
    path('cert/<str:id>', views.CertDetail.as_view(), name='cert_detail'),
    ...
    # path('skill/<str:id>', views.SkillDetail.as_view(), name='skill_detail'),
